    ...
    <div className="w-[95%]">
      <section className="flex flex-col justify-center items-center max-w-full">
        <div className="w-full mb-8 ">
          <h1 className="mb-5 pb-3 uppercase border-b">Choose For You</h1>
          <SliderUtil data={randomMovies} />
        </div>

        <div className="w-full mb-8">
          <h1 className="mb-5 pb-3 uppercase border-b">Top Movies</h1>
          <SliderUtil data={topMovies} />
        </div>

        <div className="w-full mb-8">
          <h1 className="mb-5 pb-3 uppercase border-b">Choose Movie</h1>
